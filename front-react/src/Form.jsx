...
const handleRegist = () => {
  setVegeList([...vegeList, { id: vegeId, name: vegeName, color: vegeColor }]);
...
<form onSubmit="{handleRegist}">
  <div className="form-group">
    ...
    onChange={(e) => { setVegeId(e.target.value); }} />
  </div>
  <div className="form-group">
  ...
  <div className="form-group">
    ...
    <input type="text" name="color" id="color" className="form form-control"
    onChange={(e) => { setVegeColor(e.target.value); }} />
  </div>
